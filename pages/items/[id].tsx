  ...
  return (
    <div className="px-4 py-10">
      <div className="mb-8">
        ...
        <div className="flex flex-row items-center space-x-3 py-3 border-y cursor-pointer">
        ...
        <div className="mt-5">
          ...
          <div className="flex flex-row items-center justify-between space-x-2">
            ...
            <button className="p-3 flex flex-row items-center justify-center text-gray-400 rounded-md hover:bg-gray-100 hover:text-gray-500 ">
              <svg
                className="h-6 w-6 "
